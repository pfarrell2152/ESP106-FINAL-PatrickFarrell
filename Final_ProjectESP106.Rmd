...
# Define the column ranges for the pH data
...
Now I would like to average pH for the entire region. This will allow me to get a clearer picture of regional differences in pH.
...
```
For the second part of my project I am going to use raster data to see the the precipitation level in each region. Data downloaded from worldclim.org
...
We can see from this that Paso Robles and Napa have lower average temperature than lodi. 
...
There are couple issues with these plots. The raster that I am using does not have enough cells to clearly differentiate precipitation within a region. However, we are able to se that Napa gets more precipitation on average than Paso Robles and Lodi. 